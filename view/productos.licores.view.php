          ...
          <div class="row row-90 justify-content-center">
            <div class="col-lg-8 col-xl-9">
              <div class="product-top-panel group-lg">
                <div class="product-top-panel-title">Mostrando 1–12 de 18 resultados</div>
                <div class="product-top-panel-select">
                  ...
                  <select class="form-input select-filter" data-minimum-results-for-search="Infinity" data-constraints="@Required">
                    <option value="1">Ordenar por novedad</option>
                      ...
                      <table class="table-custom table-cart">
                        <thead>
                          <tr style="background-color:#ff4a4a;">
                            <th class="text-white"><ion-icon name="search-outline"></ion-icon> Búsqueda: Cervezas, Vinos y Licores</th>
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <a class="table-cart-figure" href="single-product.html">
                                <img src="../util/images/product-mini-7-146x132.jpg" alt="" width="146" height="132"/>
                              </a>
                                <a class="table-cart-link" href="single-product.html">Duraznos</a>
                            </td>
                            <td>S/. 2.50</td>
                            <td>
                              ...
                              <div class="form-button">
                                <button class="button button-primary button-pipaluk button-md" type="submit">AGREGAR</button>
                              </div>
                            </td>
                          </tr>
                          <tr>
                            <td><a class="table-cart-figure" href="single-product.html"><img src="../util/images/product-mini-8-146x132.jpg" alt="" width="146" height="132"/></a><a class="table-cart-link" href="single-product.html">Manzanas</a></td>
                            <td>S/. 4.50</td>
                            <td>
                              <div class="table-cart-stepper">
                                <input class="form-input" type="number" data-zeros="true" value="1" min="1" max="1000">
                          ...
                          <tr>
                            <td><a class="table-cart-figure" href="single-product.html"><img src="../util/images/product-2-270x280.png" alt="" width="146" height="132"/></a><a class="table-cart-link" href="single-product.html">Arándanos</a></td>
                            <td>S/. 6.00</td>
                            <td>
                              <div class="table-cart-stepper">
                                <input class="form-input" type="number" data-zeros="true" value="1" min="1" max="1000">
                          ...
                          <tr>
                            <td><a class="table-cart-figure" href="single-product.html"><img src="../util/images/product-4-270x280.png" alt="" width="146" height="132"/></a><a class="table-cart-link" href="single-product.html">Kiwis</a></td>
                            <td>S/. 3.20</td>
                            <td>
                              <div class="table-cart-stepper">
                                <input class="form-input" type="number" data-zeros="true" value="1" min="1" max="1000">
                  ...
                  <ul class="list list-shop-filter">
                    <li>
                      <label class="checkbox-inline">
                        <input name="input-group-radio" value="checkbox-1" type="checkbox">Fruits
                      </label><span class="list-shop-filter-number">2</span>
                    </li>
                    <li>
                      <label class="checkbox-inline">
                        <input name="input-group-radio" value="checkbox-2" type="checkbox">Vegetables
                      </label><span class="list-shop-filter-number">1</span>
                    </li>
                    <li>
                      <label class="checkbox-inline">
                        <input name="input-group-radio" value="checkbox-3" type="checkbox">Exotic
                      </label><span class="list-shop-filter-number">3</span>
                    </li>
                    <li>
                      <label class="checkbox-inline">
                        <input name="input-group-radio" value="checkbox-4" type="checkbox">Grocery
                      </label><span class="list-shop-filter-number">1</span>
                    </li>
                  </ul>
                </div>
                  ...
                  <div class="list-popular-product">
                    <div class="list-popular-product-item">
                      ...
                      <article class="product-minimal unit unit-spacing-md">
                        <div class="unit-left"><a class="product-minimal-figure" href="single-product.html"><img src="images/product-mini-1-108x100.png" alt="" width="108" height="100"/></a></div>
                        <div class="unit-body">
                    ...
                    <div class="list-popular-product-item">
                      <!-- Product Minimal-->
                      <article class="product-minimal unit unit-spacing-md">
                        <div class="unit-left"><a class="product-minimal-figure" href="single-product.html"><img src="images/product-mini-2-108x100.png" alt="" width="108" height="100"/></a></div>
                        <div class="unit-body">
                    ...
                    <div class="list-popular-product-item">
                      <!-- Product Minimal-->
                      <article class="product-minimal unit unit-spacing-md">
                        <div class="unit-left"><a class="product-minimal-figure" href="single-product.html"><img src="images/product-mini-3-108x100.png" alt="" width="108" height="100"/></a></div>
                        <div class="unit-body">
